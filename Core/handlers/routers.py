...
from Core.handlers.send_files import get_last_files, send_file, send, send_last_files, get_description, get_addresse
from Core.handlers.save_files import save_audio, save_video, save_photo, save_sticker, save_document, save, \
    file_description
...
sending_router.message.register(get_description, F.text, GetFileStates.description_state)
saving_router.message.register(get_addresse, F.contact, GetFileStates.send_files_state)
